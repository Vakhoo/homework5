                ...
                <div class="feature_article_wrapper">
                    ...
                    <div class="feature_article_inner">
                        ...
                        <div class="feature_article_title">
                            <h1><a href="{{ route('sitesingle', ["id"=>$data[0]->id]) }}" target="_self">{{$data[0]->title}}</a></h1>
                        </div>
                        <!-- feature_article_title -->

                        <div class="feature_article_date"><a href="#" target="_self">Created at: {{$data[0]->created_at}}</a></div>
            ...
            <div class="col-md-5">
                <div class="feature_static_wrapper">
                    ...
                    <div class="feature_article_inner">
                        ...
                        <div class="feature_article_title">
                            <h1><a href="{{ route('sitesingle', ["id"=>$data[1]->id]) }}" target="_self">{{$data[1]->title}}</a></h1>
                        </div>
                        <!-- feature_article_title -->

                        <div class="feature_article_date"><a href="#" target="_self">Created at: {{$data[1]->created_at}}</a></div>
                        <!-- feature_article_date -->
            ...
            <div class="col-md-5">
                <div class="feature_static_last_wrapper">
                    ...
                    <div class="feature_article_inner">
                        ...
                        <div class="feature_article_title">
                            <h1><a href="{{ route('sitesingle', ["id"=>$data[2]->id]) }}" target="_self">{{$data[2]->title}}</a></h1>
                        </div>
                        <!-- feature_article_title -->
